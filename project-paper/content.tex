...
\begin{figure}[!ht]
        ...
        \caption{Hand written numbers in MNIST Dataset}\label{f:MNIST-digits-small}
\end{figure}

\begin{figure}[!ht]
        \centering\includegraphics[width=\columnwidth]
        {images/mnist-digit-big.png}
        \caption{Hand written number in MNIST Dataset}\label{f:MNIST-digit}
\end{figure}
...
\begin{figure}[!ht]
        ...
        \caption{Deep Neural Network}\label{f:Deep Neural Network}
\end{figure}
...
\begin{figure}[!ht]
        ...
        \caption{ReLU Activation Function}\label{f:ReLU-function}
\end{figure}
...
\begin{figure}[!ht]
        ...
        \caption{Sigmoid Activation Function}\label{f:Sigmoid-function}
\end{figure}
